...
const ImageUpload: FunctionComponent<$Props> = ({ isActive, onClose, onSaveFile }) => {
  ...
  const onUpload = useCallback((event: ProgressEvent<FileReader>) => {
  ...
  return (
    <DisplayModal title="Upload Avatar"
      isActive={isActive}
      onClose={onClose} 
      onSave={onSave}
      loading={loading}>
