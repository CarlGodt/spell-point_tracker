...
const CharacterDetails: FunctionComponent<$Props> = ({
  character,
  onUpdate,
}) => {
  ...
  return (
    <Content>
      <Content hasTextAlign="centered">
        {hasImage && (
          <Image
            src={`data:image/jpeg;base64,${btoa(character.getImage())}`}
      ...
      <Table>
        <tbody>
          ...
          <tr>
            <td>
              <strong>Max Spellpoints:</strong>
            </td>
            <td>{character.getMaxSpellPoints()}</td>
          </tr>
          <tr>
            <td>
              <strong>Max Spellslot:</strong>
            </td>
            <td>{character.getMaxSpellSlotClass().slotLevel}</td>
          </tr>
        </tbody>
      </Table>
    </Content>
